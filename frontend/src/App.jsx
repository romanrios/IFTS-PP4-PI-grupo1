...
import MichiDetailPage from "./pages/MichiDetailPage/MichiDetailPage";
    ...
    <BrowserRouter>
      ...
      <main>
        <Routes>
          ...
          <Route path="/michis/:id" element={<ProtectedRoute><MichiDetailPage /></ProtectedRoute>} />
          <Route path="/solicitudes" element={<ProtectedRoute adminOnly><SolicitudesPage /></ProtectedRoute>} />
